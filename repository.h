...
typedef enum statusRetornoArquivo{
    RETORNA_FIM = 0,
    RETORNA_SUCESSO = 1,
    RETORNA_FALHA = -1
} statusRetornoArquivo_t;
...
statusRetornoArquivo_t repositoryCarregarArquivo     
   (const char *nomeArquivo, lista_t    *lista);
                                            
statusRetornoArquivo_t repositoryGerarArquivoParcial 
   (const char *nomeOrigem, const char *nomeDestino,
